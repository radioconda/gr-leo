...
class leo_channel(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.variable_tracker_0 = variable_tracker_0 = leo.tracker_make(variable_satellite_0, 35.3333, 25.1833, 1, '2018-09-25T15:48:25.0000000Z', '2018-09-25T15:58:35.0000000Z', 10000, 435E6, 435e6, 37, tracker_tx_antenna, tracker_rx_antenna, 1, 210, 19200)
